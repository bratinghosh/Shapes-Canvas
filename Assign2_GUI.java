...
public class Assign2_GUI {
	...
	/**
	 * Creates an instance of the Assign2_GUI class and calls its start() method
	...
	/**
	 * Builds the GUI and allows users to start drawing regular n-sided
	 * polygons.
	 */
	public void start() {
		frame = new JFrame();
	...
	class MyDrawingPanel2 extends JPanel implements MouseListener,
			MouseMotionListener {
	...
	class MyToolsPanel2 extends JPanel implements ItemListener, ChangeListener {
		...
		public MyToolsPanel2() {
			...
			nSlider = new JSlider(JSlider.HORIZONTAL, 3, 12,
			...
			c = new GridBagConstraints(0, 1, 1, 1, 0.6, 1,
			...
			sidesPanel.setBorder(BorderFactory
					.createTitledBorder("Number of sides"));
